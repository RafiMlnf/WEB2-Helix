...
class Product_model extends CI_Model
{
	...
	{
		$this->db->like('nama_kolom', $keyword); // Ganti 'nama_kolom' dengan nama kolom yang ingin dicari
		$query = $this->db->get('nama_tabel'); // Ganti 'nama_tabel' dengan nama tabel yang sesuai
		return $query->result();
	}
}
